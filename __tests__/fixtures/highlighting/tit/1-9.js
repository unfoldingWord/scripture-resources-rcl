module.exports = {
  ...
  { type: 'text', text: '.\n\n' },
  { tag: 'p', nextChar: '\n', type: 'paragraph' }],
  expected: [{ text: 'τῇ', occurrence: 1, occurrences: 2 },
  { text: 'διδασκαλίᾳ', occurrence: 1, occurrences: 1 },
  { text: 'τῇ', occurrence: 2, occurrences: 2 },
  { text: 'ὑγιαινούσῃ', occurrence: 1, occurrences: 1 }]
}